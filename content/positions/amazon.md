...
already runs at 7.9% operating margin and International at 4.1%, and the company expects to more
than double its fleet of robotic arms in 2026. Every point of automation lands on an enormous
revenue base.
...
**Free cash flow has gone.** Amazon raised 2026 capital expenditure guidance to $220bn from $200bn,
and trailing twelve-month free cash flow is an outflow of $7.6bn against an inflow of $18.2bn a
year earlier. In a single quarter free cash flow fell from $26bn to $1.2bn. The operating business
is performing; the cash is going into the ground.
...
- **AWS growth decelerating** back toward the high teens while capex stays at this level.
- **Free cash flow staying negative into 2027**, which would make the build-out a structural change
  in the business rather than a phase of it.
- **Retail margins flat for two more years**, which would say automation is being competed away in
  price rather than kept.
- **A serious challenge to the fulfilment network's economics**, whether regulatory or from labour
  costs.
