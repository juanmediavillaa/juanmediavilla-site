...
**Amazon owns the two hardest things to rebuild: the cloud the internet runs on, and the logistics
network that moves physical goods.** I intend to hold it for a long time, because neither of those is
displaced by a better model or a cheaper competitor.
...
the installed base of Prime, decades of supplier relationships. Software eats a lot of things; it
does not eat a warehouse network. That is the part of Amazon I am least worried about.

@figure amzn-margins.csv

**The margin story is where the upside sits, and the arithmetic is forgiving.** AWS already earns
...
**Whether AWS growth holds.** Four quarters of acceleration is the core of the thesis. A slide back
toward the high teens while capital expenditure stays at this level would mean paying up for capacity
into softening demand.

**Whether free cash flow recovers.** An outflow for a year is a build-out. An outflow through 2027
